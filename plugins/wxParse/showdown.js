  ...
  for (var o = 0; o < e.length; ++o) {
    ...
    if (a.listeners) {
      ...
      for (var l in a.listeners)
        if (a.listeners.hasOwnProperty(l) && "function" != typeof a.listeners[l]) return t.valid = !1, t.error = s + '"listeners" property must be an hash of [event name]: [callback]. listeners.' + l + " must be a function but " + _typeof(a.listeners[l]) + " given", t
    }
    if (a.filter) {
...
var rgxFindMatchPos = function(e, r, n, t) {
  ...
  do {
    for (o = 0; a = u.exec(e);)
      if (d.test(a[0])) o++ || (s = u.lastIndex, i = s - a[0].length);
      else if (o && !--o) {
...
showdown.helper.matchRecursiveRegExp = function(e, r, n, t) {
  ...
  function r(e, r) {
    ...
    for (var s = 0; s < e.length; ++s) {
      ...
      if (e[s].hasOwnProperty(l))
        for (var c in e[s].listeners) e[s].listeners.hasOwnProperty(c) && t(c, e[s].listeners[c])
    }
  }
  ...
  var t = function(e, r, t, o, s, a, i, l) {
    ...
    var p = '<a href="' + u + '"';
    return "" !== d && null !== d && (d = d.replace(/"/g, "&quot;"), d = showdown.helper.escapeCharacters(d, "*_", !1), p += ' title="' + d + '"'), p += ">" + c + "</a>"
  };
  ...
  var s = /\b(((https?|ftp|dict):\/\/|www\.)[^'">\s]+\.[^'">\s]+)(?=\s|$)(?!["<>])/gi,
    a = /<(((https?|ftp|dict):\/\/|www\.)[^'">\s]+)>/gi,
    i = /(?:^|[ \n\t])([A-Za-z0-9!#$%&'*+-\/=?^_`\{|}~\.]+@[-a-z0-9]+(\.[-a-z0-9]+)*\.[a-z]+)(?:$|[ \n\t])/gi,
    l = /<(?:mailto:)?([-.\w]+@[-a-z0-9]+(\.[-a-z0-9]+)*\.[a-z]+)>/gi;
  return e = e.replace(a, t), e = e.replace(l, o), r.simplifiedAutoLink && (e = e.replace(s, t), e = e.replace(i, o)), e = n.converter._dispatch("autoLinks.after", e, r, n)
  ...
  return e = n.converter._dispatch("codeSpans.before", e, r, n), void 0 === e && (e = ""), e = e.replace(/(^|[^\\])(`+)([^\r]*?[^`])\2(?!`)/gm, function(e, r, n, t) {
    var o = t;
  ...
  function t(e, r, t, o, s, a, i, l) {
    ...
    r = r.replace(/"/g, "&quot;"), r = showdown.helper.escapeCharacters(r, "*_", !1), o = showdown.helper.escapeCharacters(o, "*_", !1);
    var d = '<img src="' + o + '" alt="' + r + '"';
    return l && (l = l.replace(/"/g, "&quot;"), l = showdown.helper.escapeCharacters(l, "*_", !1), d += ' title="' + l + '"'), s && a && (s = "*" === s ? "auto" : s, a = "*" === a ? "auto" : a, d += ' width="' + s + '"', d += ' height="' + a + '"'), d += " />"
  }
  e = n.converter._dispatch("images.before", e, r, n);
  var o = /!\[(.*?)]\s?\([ \t]*()<?(\S+?)>?(?: =([*\d]+[A-Za-z%]{0,4})x([*\d]+[A-Za-z%]{0,4}))?[ \t]*(?:(['"])(.*?)\6[ \t]*)?\)/g,
    s = /!\[([^\]]*?)] ?(?:\n *)?\[(.*?)]()()()()()/g;
  ...
  for (var t = e.split(/\n{2,}/g), o = [], s = t.length, a = 0; a < s; a++) {
    var i = t[a];
    i.search(/~(K|G)(\d+)\1/g) >= 0 ? o.push(i) : (i = showdown.subParser("spanGamut")(i, r, n), i = i.replace(/^([ \t]*)/g, "<p>"), i += "</p>", o.push(i))
  }
  for (s = o.length, a = 0; a < s; a++) {
    for (var l = "", c = o[a], h = !1; c.search(/~(K|G)(\d+)\1/) >= 0;) {
      var u = RegExp.$1,
        d = RegExp.$2;
      l = "K" === u ? n.gHtmlBlocks[d] : h ? showdown.subParser("encodeCode")(n.ghCodeBlocks[d].text) : n.ghCodeBlocks[d].codeblock, l = l.replace(/\$/g, "$$$$"), c = c.replace(/(\n\n)?~(K|G)\d+\2(\n\n)?/, l), /^<pre\b[^>]*>\s*<code\b[^>]*>/.test(c) && (h = !0)
    }
    o[a] = c
  }
  ...
  return r.strikethrough && (e = n.converter._dispatch("strikethrough.before", e, r, n), e = e.replace(/(?:~T){2}([\s\S]+?)(?:~T){2}/g, "<del>$1</del>"), e = n.converter._dispatch("strikethrough.after", e, r, n)), e
