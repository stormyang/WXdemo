...
function HTMLParser(e, t) {
  function a(e, a, s, n) {
    if (a = a.toLowerCase(), block[a])
      for (; l.last() && inline[l.last()];) r("", l.last());
    if (closeSelf[a] && l.last() == a && r("", a), n = empty[a] || !!n, n || l.push(a), t.start) {
      var i = [];
  ...
  for (l.last = function() {
    ...
    else if (0 == e.indexOf("\x3c!--") ? (s = e.indexOf("--\x3e")) >= 0 && (t.comment && t.comment(e.substring(4, s)), e = e.substring(s + 3), n = !1) : 0 == e.indexOf("</") ? (i = e.match(endTag)) && (e = e.substring(i[0].length), i[0].replace(endTag, r), n = !1) : 0 == e.indexOf("<") && (i = e.match(startTag)) && (e = e.substring(i[0].length), i[0].replace(startTag, a), n = !1), n) {
      s = e.indexOf("<");
