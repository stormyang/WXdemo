    ...
    next: function() {
      ...
      if (0 !== this.mq.length && this.running.length < this.MAX_REQUEST - 1) {
        ...
        return n.complete = function() {
          ...
          e.running.splice(e.running.indexOf(n.t), 1), delete e.map[n.t], r && r.apply(n, i), e.next()
            ...
            get: function() {
              return function(e) {
                ...
                if (n.$addons.promisify) {
                  var i = void 0,
                    a = new Promise(function(r, a) {
                      var o = {};
                      ["fail", "success", "complete"].forEach(function(i) {
                        o[i] = e[i], e[i] = function(e) {
                          n.$interceptors[t] && n.$interceptors[t][i] && (e = n.$interceptors[t][i].call(n, e)), "success" === i ? r(e) : "fail" === i && a(e)
                        }
                ...
                if (["fail", "success", "complete"].forEach(function(r) {
                    o[r] = e[r], e[r] = function(e) {
                      n.$interceptors[t] && n.$interceptors[t][r] && (e = n.$interceptors[t][r].call(n, e)), o[r] && o[r].call(n, e)
                    }
