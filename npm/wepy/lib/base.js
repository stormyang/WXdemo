...
var _event = require("./event.js"),
  ...
  PAGE_EVENT = ["onLoad", "onReady", "onShow", "onHide", "onUnload", "onPullDownRefresh", "onReachBottom", "onShareAppMessage", "onPageScroll", "onTabItemTap"],
  APP_EVENT = ["onLaunch", "onShow", "onHide", "onError", "onPageNotFound"],
  $bindEvt = function e(n, t, o) {
...
exports.default = {
  $createApp: function(e, n) {
    var t = {},
      o = new e;
    return this.$instance || (o.$init(this, n), this.$instance = o, this.$appConfig = n), 2 === arguments.length && !0 === arguments[1] && (t.$app = o), o.$wxapp = getApp(), APP_EVENT = APP_EVENT.concat(n.appEvents || []), PAGE_EVENT = PAGE_EVENT.concat(n.pageEvents || []), APP_EVENT.forEach(function(e) {
      t[e] = function() {
  ...
  $createPage: function(e, n) {
    var t = this,
      o = {},
      a = new e;
    return "string" == typeof n && (this.$instance.$pages["/" + n] = a), a.$initMixins(), ("boolean" == typeof n && n || 3 === arguments.length && !0 === arguments[2]) && (o.$page = a), o.onLoad = function() {
      for (var n = arguments.length, o = Array(n), r = 0; r < n; r++) o[r] = arguments[r];
      !("options" in this) && (this.options = o.length ? o[0] : {}), a.$name = e.name || "unnamed", a.$init(this, t.$instance, t.$instance);
      var i = t.$instance.__prevPage__,
        p = {};
      p.from = i || void 0, i && i.$preloadData && (p.preload = i.$preloadData, i.$preloadData = void 0), a.$prefetchData && (p.prefetch = a.$prefetchData, a.$prefetchData = void 0), o.push(p), a.$onLoad.apply(a, o), a.$apply()
    }, o.onUnload = function() {
      ...
      var r = getCurrentPages(),
        i = r[r.length - 1].__route__,
        p = r[r.length - 1].__wxWebviewId__;
      t.$instance.__wxWebviewId__ !== p && (a.$wxpage = this, t.$instance.__route__ = i, t.$instance.__wxWebviewId__ = p, [].concat(a.$mixins, a).forEach(function(e) {
