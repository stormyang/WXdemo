...
exports.default = {
  ...
  $extend: function() {
    var t, e, r, n, o, i, u = arguments[0] || {},
      c = 1,
      a = arguments.length,
      l = !1,
      f = this;
    for ("boolean" == typeof u && (l = u, u = arguments[c] || {}, c++), "object" !== (void 0 === u ? "undefined" : _typeof(u)) && "function" != typeof u && (u = {}), c === a && (u = this, c--); c < a; c++)
      if (t = arguments[c])
        for (e in t) r = u[e], n = t[e], u !== n && (l && n && (f.$isPlainObject(n) || (o = Array.isArray(n))) ? (o ? (o = !1, i = r && Array.isArray(r) ? r : []) : i = r && f.$isPlainObject(r) ? r : {}, u[e] = f.$extend(l, i, n)) : u[e] = n);
    return u
  },
  $copy: function(t) {
  ...
  $resolvePath: function(t, e) {
    ...
    var r = t.split("/");
    return "." === e[0] && "/" === e[1] ? (e = e.substr(2), "." !== e[0] ? (r.length ? r[r.length - 1] = e : r = [e], 1 === r.length ? "/" + r[0] : r.join("/")) : this.$resolvePath(r.join("/"), e)) : "." === e[0] && "." === e[1] && "/" === e[2] ? (e = e.replace(/^\.*/gi, ""), r.pop(), this.$resolvePath(r.join("/"), "." + e)) : "." === e[0] ? this.$resolvePath(t, e.substr(1)) : void 0
  },
