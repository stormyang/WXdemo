...
var _createClass = function() {
  ...
  Index = function(e) {
    ...
    return _inherits(t, e), _createClass(t, [{
        ...
        var t = _asyncToGenerator(regeneratorRuntime.mark(function e(t, n) {
          ...
          return regeneratorRuntime.wrap(function(e) {
            for (;;) switch (e.prev = e.next) {
              case 0:
                return r = this, o = _wepy2.default.getStorageSync(_constant.USER_SPECICAL_INFO) || {}, a = o.openid, e.next = 5, _api2.default.getUserInfo({
                  query: {
                    openId: a
                  }
                });
              case 5:
                i = e.sent, 0 == i.data.code ? (i.data.user.mobile.length > 0 ? this.bShowBind = !1 : this.bShowBind = !0, r.$apply()) : _tip2.default.error(i.data.msg), r.showLoading = !1;
              case 8:
              case "end":
                return e.stop()
            }
      ...
      value: function() {
        var e = this,
          t = _wepy2.default.getStorageSync(_constant.USER_INFO);
        e.avatarUrl = t.avatarUrl, e.nickName = t.nickName, wx.hideShareMenu()
      }
    }, {
      key: "onShow",
      value: function() {
