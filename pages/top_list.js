...
var _createClass = function() {
  ...
  TopList = function(e) {
    ...
    return _inherits(t, e), _createClass(t, [{
        ...
        var t = _asyncToGenerator(regeneratorRuntime.mark(function e(t, r) {
          ...
          return regeneratorRuntime.wrap(function(e) {
            for (;;) switch (e.prev = e.next) {
              ...
              case 3:
                n = e.sent, 0 == n.data.code ? (o.cate = n.data.topic, wx.setNavigationBarTitle({
                  title: o.cate.title
                }), o.list = [].concat(_toConsumableArray(o.list), _toConsumableArray(n.data.list)), o.page_total = n.data.page_total, 0 == n.data.page_total && (o.is_empty = !0)) : _tip2.default.error(n.data.msg), o.showLoading = !1, o.$apply();
              case 7:
              case "end":
                return e.stop()
            }
      ...
      value: function(e) {
        var t = this;
        t.list = [], this.topicId = e.code, t.getGoodList(), wx.hideShareMenu()
      }
    }, {
      key: "onReachBottom",
      value: function() {
...
Page(require("./../npm/wepy/lib/wepy.js").default.$createPage(TopList, "pages/top_list"));