    ...
    return _inherits(t, e), _createClass(t, [{
        ...
        var t = _asyncToGenerator(regeneratorRuntime.mark(function e() {
          ...
          return regeneratorRuntime.wrap(function(e) {
            for (;;) switch (e.prev = e.next) {
              ...
              case 6:
                n = e.sent, 0 == n.data.code && (t.pendingPayCount = n.data.pendingPayCount, t.backrdersCount = n.data.backrdersCount, t.shippedCount = n.data.shippedCount, a = ["全部", {
                  name: "待处理",
      ...
      value: function() {
        ...
        if (e.showLoading = !0, console.log(e.page_total + "232===" + e.currentPage), e.page_total > e.currentPage) {
          ...
          e.preventRepeatReuqest = !0, e.currentPage++, console.log(this.currentTab), 0 == this.currentTab ? (console.log("所有订单类型"), e.getMyOrder(e.currentPage)) : 1 == this.currentTab ? (console.log("未付款订单类型"), e.orderStatus = 0, e.getMyOrder(e.currentPage)) : 2 == this.currentTab ? (console.log("待发货订单类型"), e.orderStatus = 1, e.receiveFlg = 1, e.getMyOrder(e.currentPage)) : 3 == this.currentTab && (console.log("已完成订单类型"), e.orderStatus = 4, e.getMyOrder(e.currentPage)), e.preventRepeatReuqest = !1
